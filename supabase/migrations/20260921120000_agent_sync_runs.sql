-- Journal des synchronisations d'un agent externe (manuelles, simulations, cron) :
-- visible par ceux qui gèrent l'agent, écrit uniquement par la fonction agent-sync.
