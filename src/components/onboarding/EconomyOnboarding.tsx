...
const ECONOMY_LAYERS: EconomyLayer[] = [
  {
    ...
    howEarned: "Joining quests, completing subtasks, governance votes, peer recognition",
    howSpent: "Unlocks governance rights and stewardship eligibility. Never clawed back on exit.",
    decays: false,
    withdrawable: false,
  },
  {
    ...
    howEarned: "Completing quests & subtasks, governance votes, rituals, mentorship, documentation",
    howSpent: "P2P transfer to collaborators. Use as quest incentive pool (frozen from demurrage in escrow). Demurrage resumes in your wallet.",
    decays: true,
    withdrawable: false,
  },
  {
    ...
    badge: "Fiat-backed",
    tagline: "Real mission value inside the network.",
    howEarned: "Quest distributions (OCU pie, equal split, or manual dispatch). Service payments. Campaign fundraising.",
    howSpent: "Received from quest contributions. Withdrawable to real € via Stripe Connect. No demurrage.",
    decays: false,
    withdrawable: true,
  },
  {
    ...
    badge: "Fades 1%/mo",
    tagline: "Feature fuel — never for compensation.",
    howEarned: "Subscription plans, onboarding bonuses, top-up purchases",
    howSpent: "Quota expansions, visibility boosts, gamification actions. Never used for quest payouts.",
    decays: true,
    withdrawable: false,
  },
];
