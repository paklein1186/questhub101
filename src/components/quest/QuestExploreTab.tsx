...
import { Users, Heart, Building2, UserPlus, Lightbulb, TrendingUp, CreditCard, Loader2, Mail } from "lucide-react";
    ...
    <div className="mt-6 space-y-8">
      ...
      <section className="space-y-4">
        ...
        {resolvedHosts && resolvedHosts.length > 0 && (
          <div>
            <h3 className="font-display font-semibold flex items-center gap-2 mb-2 text-sm"><Building2 className="h-4 w-4" /> Hosted by</h3>
