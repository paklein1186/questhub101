    ...
    >
      ...
      <motion.div
        animate={paused ? undefined : {
          ...
          y: isMobile
            ? [0, 100, -40, 200, 300, -60, 150, -30, 0]
            : [0, 200, 100, 400, 250, 600, 700, 500, 200, -80, 0],
        }}
        transition={{
          ...
          ease: "easeInOut",
          times: isMobile
            ? [0, 0.12, 0.25, 0.37, 0.5, 0.62, 0.75, 0.88, 1]
            : [0, 0.08, 0.18, 0.3, 0.42, 0.55, 0.65, 0.75, 0.85, 0.93, 1],
        }}
